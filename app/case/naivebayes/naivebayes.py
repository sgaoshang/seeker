...
def set_vocabulary_list(text_words):
    ...
    current_app.logger.debug("Succeeded to generate vocabulary list")
    return vocab_list
...
def vectorize_words(text_words, vocab_list):
    ...
    current_app.logger.debug("Succeeded to vectorize text words")
...
def get_trained_model(component='virt-who'):
    ...
    return vocab_list, p_words_spamicity, p_words_hamicity, 0.5
...
def classify(vocab_list, p_words_spamicity, p_words_hamicity, p_s, text_words):
    ...
    # current_app.logger.debug("Classify text: %s" % text_words)
    evaluated_label = []
    ...
    current_app.logger.debug("Classify result: %s" % evaluated_label)
...
def single_classify(vocab_list, p_words_spamicity, p_words_hamicity, p_s, text_word):
    ...
    if p1 > p0:
        ...
        evaluated_label = 0
    current_app.logger.info("Classify result: %s" % evaluated_label)
    return evaluated_label
