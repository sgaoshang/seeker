...
class Cases(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
    component = db.Column(db.String(10), default='virt-who')

    def __repr__(self):
        return '<Case {}>'.format(self.case_id)


class Component(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    component = db.Column(db.String(10), unique=True)
    search_date = db.Column(db.Date)

    def __repr__(self):
       return '<Component {}>'.format(self.component)
